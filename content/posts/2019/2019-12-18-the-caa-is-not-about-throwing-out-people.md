...
Let me get to the point: The {{< smallcaps "CAA" >}} is not about throwing people out. At all. The {{< smallcaps "NRC" >}} is a different issue. Like always, you are free to disagree. Start a healthy discussion, though. If you know me personally, you have my number already.
...
And then, we talk about the {{< smallcaps "NRC" >}} exercise in Assam. That increases noise.

The reason for {{< smallcaps "NRC" >}} in Assam was different. First of all, in Assam, the issue was not religion---it never was religion. What {{< smallcaps "BJP" >}} says does not matter. The tribal people of the Assam region felt that because there was so much influx of people from Bangladesh---both Hindus and Muslims---that their ethnic identity and that of the land was getting eroded. It did not matter to them which religion the immigrants belonged to; all that mattered was _that the immigrants did not belong to Assam_.
...
The task that remained now was to identify those illegal immigrants, and thus comes the {{< smallcaps "NRC" >}} (National Register of Citizens). Something that had not happened for three decades after the Assam Accord.
...
Not the {{< smallcaps "BJP" >}} alone, but everyone. Name one political party in 2019 has the "audacity" to throw out over ten lac Hindus from India, saying they are illegal immigrants? None. Not one political party would do that in 2019. Not Congress, not the Left, and most certainly not the {{< smallcaps "BJP" >}}. If the {{< smallcaps "BJP" >}} pitched something like that, I would look to the west in the morning to welcome the sun.

Now, if you understand what the {{< smallcaps "CAA" >}} 2019 says, you will know that it goes directly against the Assam Accord of 1985, and the agreement between India and Bangladesh in 1971. It kills the purpose of the Assam Movement. Also, it renders the efforts of the government and the 1,200 crore rupees spent in the {{< smallcaps "NRC" >}} wasted.

The {{< smallcaps "CAA" >}} was to handle this issue like a hot knife on butter, but ended up being a pneumatic drill (a.k.a. jackhammer) on granite.

Again, not your trigger. Do not jump.

## What happens if I cannot prove my citizenship

At this point, answer to the question is unknown. All we can do is look at Assam, see what is happening and speculate. The government has made no official statement on what the criteria for {{< smallcaps "NRC" >}} are, or what the process is. We would need to wait.
...
This is what makes the Act malicious. The Home Minister says, 'Understand the chronology. First, the {{< smallcaps "CAB" >}} will come [into existence]. Then, there will be the {{< smallcaps "NRC" >}} [exercise].'

During the {{< smallcaps "NRC" >}} exercise, based on our experience, everyone is a suspected non-citizen to begin with. The citizens then establish their citizenship and get included in the registry.
...
All that we say about the {{< smallcaps "NRC" >}} will be mere speculation; the government has not shared official word on the exercise.

Everyone says, 'Do not look at {{< smallcaps "CAA" >}} with {{< smallcaps "NRC" >}}---the two are separate.' I cannot help but look at them together, because Mr Shah said the latter will follow the former, and the goal is to expel "intruders" from the country. Should I read between the lines along with the current narratives? No? All right.

The Amendment, _if_ married to the {{< smallcaps "NRC" >}}, goes against the _spirit of_ the Constitution of India, not the Constitution itself. This is beyond technicalities.

Do I support the {{< smallcaps "NRC" >}}?
...
Look, the {{< smallcaps "NRC" >}} is expensive. 12 billion rupees is no small amount for one state. To find what, 1.9 million immigrants. 6% of the population of Assam. This in a small state---3.09 crore people. The expense would be 52,000 crore if this exercise has to happen across India. (By simple arithmetic, not accounting for the speed of the process and the inflation, other operational difficulties, etc.) Can we afford it financially, more so _at this time_?

No. The government earns ₹97,637 crore in November 2019 from {{< smallcaps "GST" >}}[^da06660d]. The average from the last eight months is ₹97,039.625 crore.

[^da06660d]: [{{< smallcaps "GST" >}} revenue collection, Ministry of Finance](http://gstcouncil.gov.in/sites/default/files/Press-Dynamic/PIB1594406.pdf)

Is this the most pressing issue in 2019 -- 2020?

No.

Second, do we go tracking down every illegal immigrant and throw them into the detention centres? The Assam {{< smallcaps "NRC" >}} identified 6% of those evaluated, as illegal immigrants. Assam is a border state. Say, in the rest of India, we find 3% as illegal immigrants. Are there enough detention centres for 4 crore people? Or are we going to build them?
...
Or perhaps there will never be an {{< smallcaps "NRC" >}}. Good, but still, what was the necessity of this amendment?
