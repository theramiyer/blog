...
Having had the [communication]({% post_url 2017/2017-10-11-the-world-of-automation-today-part-1 %}) and the [build]({% post_url 2017/2017-10-12-the-world-of-automation-today-part-2 %}) taken care of, we wanted a streamline social communication as well. This was a relatively new thought. And this part is so small, we could do a mini case study within this post. So let's dig in.
