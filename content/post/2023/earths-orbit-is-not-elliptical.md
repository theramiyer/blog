...
You must ignore this if you wanted the earth's path to look helical. Even if you do, and you look at our supercluster, then, the path is not a helix anymore; it is a different shape altogether, because the galaxy itself is moving in the universe.
...
These statements are not lies, but a mere simplification of what are otherwise a bit more complex concepts. These simplifications help with learning more approachable.
